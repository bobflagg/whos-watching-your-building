...
- All 7 uniqueness constraints are present (one per node label: Building, Complaint, Violation, Landlord, Agency, Neighborhood, Inspection)
- No node with label `Registration` exists in the graph (renamed to `Landlord`)
